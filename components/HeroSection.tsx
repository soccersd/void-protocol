      ...
      <div className="max-w-6xl w-full mx-auto flex flex-col items-center z-10 reveal-target mt-8">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-3 px-4 py-2 border border-accent/40 bg-accent/10 backdrop-blur-sm">
            ...
            <p className="font-mono text-[10px] text-accent tracking-[0.4em] uppercase font-bold">THE ELITE COMMAND</p>
            <div className="w-2 h-2 bg-accent rounded-full animate-pulse" />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <p className="font-mono text-[11px] text-accent/80 tracking-[0.3em] uppercase">VOID-PROTOCOL: DEPLOYMENT INITIALIZED</p>
          <div className="h-px w-12 bg-gradient-to-l from-transparent to-accent/50" />
        </div>

        {/* Main Title - Ultra Aggressive */}
        <h1
          className="text-7xl md:text-[10rem] leading-none font-black tracking-tighter mb-4 text-center uppercase glitch-text text-white drop-shadow-[0_0_40px_rgba(157,0,255,0.3)]"
          data-text="THE RESONATOR SERIES"
        >
          <span className="block">THE</span>
          <span className="block text-accent">RESONATOR</span>
          <span className="block text-5xl md:text-8xl text-zinc-400">SERIES</span>
        </h1>

        {/* Tactical Divider */}
        <div className="flex items-center gap-4 mb-8">
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-accent/30 to-transparent" />
          <Icon icon="solar:hexagonal-prims-linear" className="text-2xl text-accent" />
          <div className="h-px flex-1 bg-gradient-to-r from-transparent via-accent/30 to-transparent" />
        </div>

        {/* Subtitle - Weapon Description */}
        <p className="text-center text-sm md:text-base text-zinc-300 max-w-3xl mb-12 leading-relaxed font-mono">
        ...
        <div className="w-full max-w-6xl aspect-[21/9] relative rounded-sm border border-accent/20 bg-gradient-to-b from-zinc-900/60 to-black backdrop-blur-md overflow-hidden mb-16 group shadow-[0_20px_60px_rgba(157,0,255,0.2)]">
          {/* Product Image */}
          <img 
          ...
          <div className="absolute top-4 left-6 flex flex-col font-mono text-[10px] text-zinc-400 z-30 uppercase tracking-widest space-y-1">
          ...
          <div className="absolute top-4 right-6 flex flex-col items-end font-mono text-[10px] text-zinc-500 z-30 uppercase tracking-widest space-y-1">
            <span>SECTOR: 07</span>
          ...
          <div className="absolute bottom-4 left-6 right-6 flex justify-between items-end">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[9px] text-accent tracking-wider">OPERATIONAL</span>
            </div>
          </div>
        </div>
      </div>
